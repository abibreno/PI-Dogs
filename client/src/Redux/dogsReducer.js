  ...
  switch (action.type) {
    ...
    case FILTER_BY_TEMPERAMENTS:
      ...
      const temperamentFilter =
        action.payload === "All"
          ? allDogs
          : allDogs.filter((e) => e.temperaments?.includes(action.payload)); // si el payload es igual a all, entonces que me devuelva todos los perros, sino que me devuelva los perros que incluyan el temperament que le estoy pasando por el payload
      return {
        ...state,
